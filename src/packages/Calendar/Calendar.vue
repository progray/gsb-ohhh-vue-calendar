...
const { showToolbar, showWeekdays, showFooter } = toRefs(props)
...
const contextValue = computed(() => ({
  ...
  allRenderDates: allRenderDates.value,
  transformDistance: transformDistance.value,
  transitionDuration: transitionDuration.value,
  isInTransition: isInTransition.value,
  renderRows: renderRows.value,
  weekStart: props.weekStart,
  weekdays: createWeekdays(props.weekStart),
  icons,
  changePageTo,
  changeSelectedDate,
  startTransitionAnimation,
...
provide('calendarContext', contextValue)
