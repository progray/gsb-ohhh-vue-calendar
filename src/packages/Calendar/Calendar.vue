<template>
  ...
  >
    ...
    <!-- 星期栏 -->
    <Weekdays :showWeekdays="showWeekdays" />
...
provide('currentRenderDates', currentRenderDates)
provide('allRenderDates', allRenderDates)
provide('transformDistance', transformDistance)
provide('transitionDuration', transitionDuration)
provide('isInTransition', isInTransition)
provide('renderRows', renderRows)
provide('weekStart', weekStart)
provide('changePageTo', changePageTo)
provide('changeSelectedDate', changeSelectedDate)
provide('startTransitionAnimation', startTransitionAnimation)
provide('onTransitionEnd', onTransitionEnd)
provide('markerDateList', markerDateList)
