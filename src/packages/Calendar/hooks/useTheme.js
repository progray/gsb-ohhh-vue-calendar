...
export function useTheme(props = {}) {
  ...
  const cssVariables = computed(() => ({
    ...
    '--calendar-text-color-level-1': mode.value === 'dark' ? '#e5e5e5' : '#303133',
    '--calendar-text-color-level-2': mode.value === 'dark' ? '#a3a3a3' : '#606266',
    '--calendar-text-color-level-3': mode.value === 'dark' ? '#737373' : '#909399',
    '--calendar-text-color-level-4': mode.value === 'dark' ? '#525252' : '#a8abb2',
    '--calendar-text-color-level-5': mode.value === 'dark' ? '#404040' : '#c0c4cc',
    '--calendar-background': mode.value === 'dark' ? '#171717' : 'transparent',
    '--calendar-icon-color': mode.value === 'dark' ? '#737373' : 'var(--calendar-text-color-level-3)',
    '--calendar-weekdays-color': mode.value === 'dark' ? '#e5e5e5' : 'var(--calendar-text-color-level-1)',
    '--calendar-days-value-color': mode.value === 'dark' ? '#e5e5e5' : 'var(--calendar-text-color-level-1)',
    '--calendar-days-label-color': mode.value === 'dark' ? '#a3a3a3' : 'var(--calendar-text-color-level-2)',
    '--calendar-days-other-month-color': mode.value === 'dark' ? '#404040' : 'var(--calendar-text-color-level-5)',
